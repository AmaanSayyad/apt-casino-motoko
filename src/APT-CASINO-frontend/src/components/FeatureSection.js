  ...
  const features = [
    {
      ...
      description:
        "All games use verifiable on-chain randomness through our VRF module, ensuring complete transparency and fairness in every outcome.",
      icon: "🎲",
    },
    {
      id: 2,
      ...
      description:
        "Stake tokens across multiple chains to earn APTC tokens while playing your favorite games with minimal slippage.",
      icon: "⛓️",
    },
    {
      id: 3,
      ...
      description:
        "Enjoy flexible withdrawals, transparent bonus schemes, and full control over your assets through decentralized management.",
      icon: "🔓",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-16">
          ...
          <div className="lg:col-span-7 p-[1px] bg-gradient-to-r from-red-magic to-blue-magic rounded-xl">
            <div className="bg-[#1A0015] rounded-xl p-6 md:p-8">
              <h3 className="text-white/70 text-sm uppercase tracking-wider mb-3">
                Traditional vs APT-Casino
              </h3>
              <h4 className="text-white text-2xl font-display font-medium mb-6">
                A New Era of Fair Gaming
              </h4>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-[#250020] rounded-lg p-4 border-l-2 border-red-400/50">
                  <h5 className="text-red-magic font-medium mb-2">
                    Traditional Casinos
                  </h5>
                ...
                <div className="bg-[#250020] rounded-lg p-4 border-l-2 border-blue-400/50">
                  <h5 className="text-blue-magic font-medium mb-2">
                    APT-Casino
                  </h5>
                  <ul className="space-y-2 text-white/70 text-sm">
                    <li className="flex items-start">
              ...
              <p className="text-white/80 text-sm">
                APT-Casino leverages Mantle Blockchain to provide a transparent,
                provably fair gaming experience with DeFi integration, allowing
                players to earn passive income through staking.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`bg-[#1A0015] rounded-xl p-6 h-full flex flex-col ${
