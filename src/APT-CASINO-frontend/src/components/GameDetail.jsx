    ...
    <Box
      ...
      sx={{
        ...
        "&::before": {
          ...
          bottom: "-5px",
          background:
            "linear-gradient(125deg, rgba(216, 38, 51, 0.4), rgba(104, 29, 219, 0.4), rgba(20, 216, 84, 0.4))",
        ...
        "&::after": {
          ...
          height: "3px",
          background:
            "linear-gradient(90deg, transparent, #d82633, #681DDB, #d82633, transparent)",
          opacity: 0.8,
          zIndex: 1,
        },
      }}
    >
      ...
      <Box
        sx={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(9, 0, 5, 0.25) 0%, transparent 70%)",
          filter: "blur(80px)",
          zIndex: 0,
          opacity: 0.7,
      ...
      <Box
        sx={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(9, 0, 5, 0.2) 0%, transparent 70%)",
          filter: "blur(50px)",
      ...
      <Box
        sx={{
          ...
          padding: "1px",
          background:
            "linear-gradient(125deg, rgba(9, 0, 5, 0.5), rgba(9, 0, 5, 0.5))",
          opacity: 0.4,
          zIndex: 0,
