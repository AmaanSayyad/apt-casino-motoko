    ...
    const interval = setInterval(() => {
      ...
      setTokenData((prev) => ({
        ...
        priceChange24h: parseFloat(
          (prev.priceChange24h + (Math.random() * 0.4 - 0.2)).toFixed(2)
        ),
              ...
              <div className="bg-[#1A0015] rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-medium">
                      {formatNumber(tokenData.maxSupply)}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="p-[1px] bg-gradient-to-r from-red-magic to-blue-magic rounded-xl">
              <div className="bg-[#1A0015] rounded-xl p-6">
                <h3 className="text-white text-lg font-medium mb-2">
                  Ready to invest in APTC?
                </h3>
                <p className="text-white/70 text-sm mb-4">
                  Stake APTC to earn passive income while playing your favorite
                  games.
                </p>
                <Link to="/bank">
