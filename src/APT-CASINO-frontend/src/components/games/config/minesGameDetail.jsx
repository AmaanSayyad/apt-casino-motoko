export const gameData = {
  ...
  description:
    "Unearth hidden gems while avoiding mines in this thrilling crypto game!",
...
export const winProbabilities = [
  {
    config: "1 mine (24 safe tiles)",
    probability: 96.0,
    color: "from-green-500 to-green-700",
  },
  {
    config: "3 mines (22 safe tiles)",
    probability: 88.0,
    color: "from-teal-500 to-teal-700",
  },
  {
    config: "5 mines (20 safe tiles)",
    probability: 80.0,
    color: "from-blue-500 to-blue-700",
  },
  {
    config: "10 mines (15 safe tiles)",
    probability: 60.0,
    color: "from-yellow-500 to-yellow-700",
  },
  {
    config: "15 mines (10 safe tiles)",
    probability: 40.0,
