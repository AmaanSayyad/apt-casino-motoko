...
export const bettingTableData = {
  ...
  description:
    "Explore our comprehensive betting options and maximize your winning potential:",
  options: [
    {
      ...
      bets: [
        ...
        {
          name: "Corner",
          description: "Bet on four numbers in a square",
          payout: "8:1",
        },
        {
          name: "Six Line",
    ...
    },
    {
      ...
      bets: [
        ...
        {
          name: "Even/Odd",
          description: "Bet on all even or odd numbers",
          payout: "1:1",
        },
        {
          name: "High/Low",
          description: "Bet on 1-18 or 19-36",
          payout: "1:1",
        },
        {
          name: "Dozen",
        ...
        {
          name: "Column",
          description: "Bet on a vertical column of numbers",
          payout: "2:1",
        },
      ],
    },
