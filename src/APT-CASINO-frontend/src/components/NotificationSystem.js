...
// Utility function for handling pointer events
  ...
  return (
    ...
    >
      <div className="flex items-center">
        <span className="mr-3 text-white">{NotificationIcons[type]}</span>
...
const NotificationsContainer = ({ notifications, onClose }) => {
  ...
  return createPortal(
    <div className="fixed top-[120px] right-4 z-[9999] w-full max-w-sm notifications-container">
