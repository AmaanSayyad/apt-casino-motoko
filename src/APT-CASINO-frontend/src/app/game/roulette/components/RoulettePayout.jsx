  ...
  return (
    ...
    >
      ...
      <Typography
        ...
        sx={{ mb: 3, mt: 1 }}
      >
        European Roulette offers a 2.7% house edge across all bets. See payout
        ratios below:
      </Typography>
        ...
        <Box sx={{ minWidth: "650px" }}>
          <Grid
            ...
            sx={{
              ...
              background:
                "linear-gradient(90deg, rgba(104, 29, 219, 0.2), rgba(216, 38, 51, 0.2))",
              mb: 1,
            }}
          >
            <Grid item xs={3}>
      ...
      <Box
        sx={{
          ...
          borderRadius: 2,
          background:
            "linear-gradient(135deg, rgba(216, 38, 51, 0.05) 0%, rgba(216, 38, 51, 0.15) 100%)",
      ...
      >
        ...
        />
        <Typography variant="body2" color="rgba(255,255,255,0.8)">
          European Roulette (single zero) offers a better 2.7% house edge
          compared to American Roulette's 5.26% edge (double zero).
        </Typography>
      </Box>
    </Paper>
  );
