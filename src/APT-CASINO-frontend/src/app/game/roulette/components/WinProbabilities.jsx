    ...
    >
        ...
        >
          <Button
            ...
            sx={{
              fontSize: "0.75rem",
              color:
                sortBy === "probability" ? "white" : "rgba(255,255,255,0.6)",
              backgroundColor:
                sortBy === "probability"
                  ? "rgba(104, 29, 219, 0.3)"
                  : "transparent",
          ...
          <Button
            ...
            sx={{
              ...
              backgroundColor:
                sortBy === "odds" ? "rgba(104, 29, 219, 0.3)" : "transparent",
              borderRadius: "18px",
              minWidth: "auto",
              p: 0.5,
              px: 1.5,
              ...
              >
                ...
                >
                  <Box>
                    ...
                    >
                      <span style={{ color: "#d82633", fontWeight: "bold" }}>
                        {item.odds}
                      </span>
                      payout ratio
                    </Typography>
                    ...
                    title={
                      <Box>
                        <Typography variant="body2">
                          ...
                          {item.type === "High/Low" &&
                            "Bet on numbers 1-18 or 19-36."}
                          {item.type === "Dozens" &&
                            "Bet on a group of 12 numbers (1-12, 13-24, or 25-36)."}
                          {item.type === "Columns" &&
                            "Bet on a vertical column of 12 numbers."}
                          {item.type === "Six Line" &&
                            "Bet on six consecutive numbers forming two rows."}
                          {item.type === "Corner" &&
                            "Bet on four numbers forming a square."}
                          {item.type === "Street" &&
                            "Bet on three consecutive numbers in a row."}
                          {item.type === "Split" &&
                            "Bet on two adjacent numbers."}
                          {item.type === "Straight Up" &&
                ...
                <Box sx={{ position: "relative", mt: 2, mb: 1 }}>
                  ...
                  >
                    ...
                    >
                      ...
                      {item.probability > 15 && item.probability <= 40 && (
                        <FaThumbsUp color="#FFA500" />
                      )}
      ...
      <Box
        sx={{
          ...
          borderRadius: 2,
          background:
            "linear-gradient(135deg, rgba(104, 29, 219, 0.05) 0%, rgba(104, 29, 219, 0.15) 100%)",
      ...
      >
        ...
        <Typography variant="body2" color="rgba(255,255,255,0.8)">
          Higher probability bets offer more frequent wins but lower payouts.
          Riskier bets have higher rewards but less chance of winning.
        </Typography>
      </Box>
    </Paper>
  );
